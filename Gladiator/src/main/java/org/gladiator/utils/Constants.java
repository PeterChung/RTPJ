 ...
 * (Constants reused from SentimentAnalysis by Prashanth Babu with the addition of NAME_KEYWORD_FILE_NAME)
 */
public final class Constants {

    //Name of the Topology. Used while launching the LocalCluster
    public static final String TOPOLOGY_NAME = "Gladiator";
    ...
    //Keywords for Names.
    //The file maps keywords to identify certain person
    public static final String NAME_KEYWORD_FILE_NAME = "NAME-KEYWORD.txt";
